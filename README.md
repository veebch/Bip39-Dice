...
You will be given a list of 8 valid 24th words. Pick one (by rolling 3 dice using and ussing the method above to get a number between 1 and 8, and no need to tell the program which), write it with the other 23. This is a valid wallet seed, and you can use it with [Electrum](http://electrum.org) or some other wallet application.
