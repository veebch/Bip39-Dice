...
To determine the final 24th word, copy the files to an [**OFFLINE**](https://en.wikipedia.org/wiki/Air_gap_(networking)) machine, and on that machine edit `rolls.txt` and replace the words with the 23 that you chose using dice. Then run:
